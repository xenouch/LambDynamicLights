 ...
 * @since 1.0.0
 */
public class RyoamicLightsMixinPlugin implements IMixinConfigPlugin {
	private final Object2BooleanMap<String> conditionalMixins = new Object2BooleanOpenHashMap<>();

	public RyoamicLightsMixinPlugin() {
		boolean ltrInstalled = RyoamicLightsCompat.isLilTaterReloadedInstalled();
		this.conditionalMixins.put("org.thinkingstudio.ryoamiclights.mixin.ltr.LilTaterBlocksMixin", ltrInstalled);
		this.conditionalMixins.put("org.thinkingstudio.ryoamiclights.mixin.ltr.LilTaterBlockEntityMixin", ltrInstalled);
	}
